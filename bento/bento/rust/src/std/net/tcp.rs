...
use crate::kernel::raw::__kernel_suseconds_t;
use crate::kernel::raw::__kernel_time_t;
use crate::kernel::raw::timeval;
    ...
    pub fn read_timeout(&self) -> io::Result<Option<Duration>> {
        ...
        unsafe {
            let ret = ffi::kernel_getsockopt(
                ...
                0xffff as i32,
                0x1012 as i32,
                &mut read_timeout as *mut timeval as *mut raw::c_char,
                &mut optlen,
            );
            if ret != 0 {
                return Err(io::Error::from_raw_os_error(ret));
        ...
        unsafe {
            let timeout = match dur {
                Some(dur) => {
                    ...
                    let secs = dur.as_secs() as __kernel_time_t;
                    let mut timeout = timeval {
                        tv_sec: secs,
                        tv_usec: dur.subsec_micros() as __kernel_suseconds_t,
                    };
            ...
            let ret = ffi::kernel_setsockopt(
                ...
                0xffff as i32,
                0x1012 as i32,
                &timeout as *const timeval as *const raw::c_char,
